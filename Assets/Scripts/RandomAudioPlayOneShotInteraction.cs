...
public class RandomAudioPlayOneShotInteraction : Interaction
{
    ...
    public override void Interact(IInteractor interactor)
    {
        ...
        switch (mode)
        {
            ...
            case AudioPlayOneShotInteractionMode.Position2D:
                ...
                AudioSource.PlayClipAtPoint(audioClips[Random.Range(0, audioClips.Length)], clipPosition.position, volume);
                break;
