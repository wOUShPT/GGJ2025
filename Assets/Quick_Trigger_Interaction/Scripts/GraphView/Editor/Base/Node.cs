...
namespace AstralShift.QTI.NodeEditor
{
    ...
    public abstract class Node : ScriptableObject
    {
        ...
        public class InteractionComponent : Attribute
        {
            private Type componentType;

            /// <summary> Tells the NodeEditor which Node Type belongs to Interaction type</summary>
            /// <param name="componentType">Interaction type that this node draws</param>
            public InteractionComponent(Type componentType)
            {
